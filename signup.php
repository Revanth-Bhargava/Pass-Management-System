...
<head>
	...
	<script>
		function confirm()
		{
			window.alert("New worker successfully added!!!");
		}
	</script>
</head>
<body class="body">
	...
	<td  rowspan=5>
	<!*********************************************************************************************************************>
		<center><br><h2 class="f3"><u>Registration Form</u></h2></center><br>
	...
	<?php
		...
		if(isset($_POST["submit"]))
		{
			...
			$user=$_POST["un"];
			$pass=$_POST["pass"];
			$add = "INSERT INTO details VALUES($wid+1,'$name','$user','$pass','$job','$dob','$gen','$add');";
			$connect->query($add);
		}
	?>
</body>
